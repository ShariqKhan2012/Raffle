...
// @dev Forked from @chainlink/contracts/src/v0.8/vrf/mocks/VRFCoordinatorV2_5Mock.sol (v1.1.1),
// @dev wired to SubscriptionAPILocal instead of the upstream SubscriptionAPI. See that file for why.
...
import {SubscriptionAPILocal} from "./SubscriptionAPILocal.sol";

contract VRFCoordinatorV2_5MockLocal is SubscriptionAPILocal, IVRFCoordinatorV2Plus {
  ...
  constructor(uint96 _baseFee, uint96 _gasPrice, int256 _weiPerUnitLink) SubscriptionAPILocal() {
    i_base_fee = _baseFee;
